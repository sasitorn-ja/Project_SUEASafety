...
const PPE_PROMPT = [
  "ตรวจรูปด้านความปลอดภัย/PPE/หน้างานเท่านั้น ถ้ารูปไม่เกี่ยวกับความปลอดภัยให้ตอบประโยคปฏิเสธมาตรฐาน",
  `ประโยคปฏิเสธมาตรฐาน: ${OUT_OF_SCOPE_REPLY}`,
  "ถ้าเกี่ยวข้อง ให้ดู PPE, สภาพหน้างาน, พื้นที่เสี่ยง, พฤติกรรมเสี่ยง แล้วตอบไทยสั้นๆ แบบนี้เท่านั้น:",
  "ชื่นชม\n1.\n2.\nควรปรับปรุง\n1.\n2.",
].join("\n");
